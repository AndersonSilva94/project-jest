# Projeto Jest :heavy_check_mark:

### Nono projeto do curso de Desenvolvimento Full Stack Web da Trybe.

## Objetivos a serem alcançados no decorrer da construção do projeto:

- Implementar testes utilizando o **Jest** para verificar se uma série de funções estão funcionando corretamente. Você colocará em prática todo o conteúdo que aprendeu sobre Jest assíncrono e Mocks aplicados a testes em Javascript.


## Como foi construído:

- Escrevendo testes para funções assíncronas;

- Aplicando conhecimentos acerca de testes utilizando o Jest;
